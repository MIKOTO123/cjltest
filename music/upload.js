(function($) {
    ...
    $(function() {
        ...
        uploader.on( 'uploadSuccess', function( fileObj ,response  ) {
		        	  console.log(fileObj.name+':uploadSuccess开始');
        ...
        uploader.on( 'uploadBeforeSend', function( object ,data , headers ) {
		        	  //console.log(object);
            console.log(object.file.name + "::::" +object.file.source.uid);
        ...
        uploader.on( 'uploadError', function( file ,response  ) {
            console.log(file.name+':uploadError');
            console.log(response);
        });
